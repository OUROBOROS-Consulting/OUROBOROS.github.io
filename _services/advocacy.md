...
included:
  - title: Situation Assessment
    description: >
      A structured conversation to understand what you are dealing with, what documentation
      exists, and what institutional channels — formal or informal — are available to you.
  - title: Documentation Strategy
    description: >
      Guidance on what to record, how to record it, and how to organize it for maximum
      clarity and future utility. A well-constructed record is often the difference between
      being believed and being dismissed.
  - title: Institutional Navigation
    description: >
      Help understanding grievance procedures, Title IX, union processes, HR systems,
      academic ombudspersons, and how to engage each strategically — including when
      not to engage them at all.
  - title: Record & Correspondence Review
    description: >
      Analysis of existing documentation, email threads, or timelines to identify
      gaps, patterns, and leverage points you may not have noticed.
...
pricing:
  - name: Initial Consultation
    rate: Free (45 min)
    notes: >
      A no-commitment conversation to understand your situation and determine
      whether I can be useful to you. No referral required.
