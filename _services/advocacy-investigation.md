...
lede: >
  ...
  build a credible record, and understand exactly what happened.
...
who: >
  ...
  Also: attorneys, organizations, veterans, workers, and whistleblowers who need someone fluent in both
  institutional documentation and evidence research.
included:
  ...
  - title: Public Records & FOIA
    description: Federal and state records requests, vital records, court documents, institutional files. I handle the complexity so you don't have to.
  - title: Background & Verification
    description: Public-source research on individuals and organizations — employment, education, addresses, litigations, regulatory history, ownership.
  ...
  - title: Report & Expert Documentation
    description: Findings synthesized into a coherent narrative with citations. Attorney-ready, trauma-informed, and built to hold up under legal and institutional scrutiny.
...
policies:
  ...
  - item: "Research discovery call: Free (30 min)"
...
pricing:
  ...
  - name: Research & Records Gathering
    rate: $125–$200/hr
    notes: >
