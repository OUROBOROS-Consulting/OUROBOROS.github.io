...
lede: >
  ...
  this page.
cta_body: Still have a question I did not answer?
---
...
1. **I never type a real person's name into a search for you.** Not even to show you how it works.
2. **We practice on me, on you, or on a public figure with no connection to anyone in the room.** Usually me. I am the safest target available.
3. **Your hands stay on your keyboard.** I teach, point, and explain. I do not drive.
4. **I do not produce a document about a person.** No profile, no dossier, no summary, no timeline about someone else.
5. **Nothing I teach is packaged as evidence.** Not for a hearing, not for a board, not for a trial.
...
**Harden your devices and accounts.** Apple's security tools are strong and almost nobody has them configured correctly. The [security audit](/resources/tutorial-apple-security-audit/) and [Advanced Data Protection](/resources/tutorial-icloud-adp/) walkthroughs are free and you do not need me to use them.

**Teach you to document it.** A record built correctly from the start is worth more than one assembled in a panic later. Start with [documenting interactions](/resources/tutorial-documenting-interactions/) and the [safety plan](/resources/tutorial-safety-plan/) guide.
...
If you are in danger right now, contact emergency services. The [survival guide](/survival-guide.html) lists resources that can help.
...
Each of those is a real boundary with a reason behind it. All three are covered in more detail on the [disclaimer](/disclaimer/) page.
...
**The site itself does not watch you.** No analytics, no cookies, no trackers, no third-party requests at all. You do not have to believe me. Open your browser's network tab and reload any page. The [privacy page](/privacy/) explains what you will see.

If you would rather not put something in a form, say so in the first message and we will find another way.

### How do I start?

[Book the free consultation](/intake). Tell me roughly what is going on. If I am the wrong person, I will say so on that call rather than take your money to find out slowly.
